...
<head>
  ...
  <script type="text/javascript" src="<?php echo BASEURL; ?>js/jquery.mask.test.js"></script>
</head>
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a href="<?php echo BASEURL; ?>index.php" class="navbar-brand">CRUD: <?php echo NOME_DO_CANDIDATO; ?></a>
        </div>
